...
class NewsItem:
    ...
    raw_extra: Optional[Dict[str, Any]] = None  # NewsNow 等 API 透传字段（热度、描述等）
    news_item_db_id: Optional[int] = None  # SQLite news_items.id（从存储读取时有值）
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "news_item_db_id": self.news_item_db_id,
        }
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "NewsItem":
        ...
        return cls(
            ...
            news_item_db_id=data.get("news_item_db_id"),
        )
